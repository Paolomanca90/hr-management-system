...
export class MenuService {
  ...
  private companyMenu: MenuItem[] = [
    ...
    },
    {
      ...
      expanded: false,
      children: [
        { id: 'archivi', icon: 'fas fa-archive', label: 'Archivi', route: '/app/attendance/archives' },
    ...
    },
    {
      ...
      expanded: false,
      children: [
        { id: 'monte-ore', icon: 'fas fa-clock', label: 'Monte Ore', route: '/app/config/working-hours' },
        { id: 'cambio-profilo', icon: 'fas fa-user-cog', label: 'Cambio Profilo Orario', route: '/app/config/schedule-profile' },
        { id: 'autorizzazione-straordinari', icon: 'fas fa-check-circle', label: 'Autorizzazione Straordinari', route: '/app/config/overtime-authorization' },
        { id: 'inizializzazione', icon: 'fas fa-play-circle', label: 'Inizializzazione Straordinari Orari', route: '/app/config/overtime-initialization' }
      ]
    }
  ];
